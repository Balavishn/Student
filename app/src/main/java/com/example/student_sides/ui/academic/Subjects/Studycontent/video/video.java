package com.example.student_sides.ui.academic.Subjects.Studycontent.video;
...
public class video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdf=findViewById(R.id.video_rec);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Video").child(clases+"-"+section).child(subject_select).child(Unit);
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                pdf_video_adapter pdf_video_adapter= new pdf_video_adapter(video.this,name,url);
